# 🖥️ Surveillance d’une Instance EC2 (AWS CloudWatch & SNS)

> **Type d'atelier :** TP Pratique AWS / Observabilité & Sécurité  
> **Durée estimée :** ⏱️ 60 minutes  
> **Services AWS utilisés :** Amazon EC2, Amazon CloudWatch, Amazon SNS, AWS Systems Manager  

---

## 📌 Présentation de l'atelier

La **journalisation** et la **surveillance** sont deux techniques indispensables mises en place pour atteindre un objectif commun. Ensemble, elles garantissent les performances optimales d’un système et un cadre de sécurité robuste. 

* **Journalisation :** Désigne l’enregistrement et le stockage d’événements de données sous la forme de fichiers journaux. Les journaux contiennent des détails de faible niveau qui offrent une visibilité sur les performances de votre système ou de vos applications dans certaines circonstances. Sur le plan de la sécurité, la journalisation permet aux administrateurs de sécurité d’identifier des signaux d’alerte qui peuvent passer inaperçus sur leur système.
* **Surveillance :** Désigne le processus d’analyse et de collecte de données qui permet de garantir des performances optimales. La surveillance permet de détecter les accès non autorisés et d’aligner l’utilisation de vos services avec le cadre de sécurité de votre organisation.
...
> ⚠️ **Note de sécurité :** Ce test vise à simuler un acte de malveillance afin de prendre le contrôle de l’instance EC2 et créer un pic de la CPU. L’augmentation de la charge CPU a plusieurs causes possibles, dont la présence d’un logiciel malveillant.

---

### 🎯 Objectifs
À la fin de cet atelier, vous serez en mesure d'effectuer les opérations suivantes :
- [x] Créer une notification Amazon SNS
- [x] Créer une alarme CloudWatch
- [x] Soumettre une instance EC2 à un test de contrainte
- [x] Confirmer qu’un e-mail Amazon SNS a été envoyé
- [x] Créer un tableau de bord CloudWatch
...
## 🛠️ Tâche 1 : Configuration d'Amazon SNS
...
![Configuration de la rubrique SNS]https://github.com/doumbia-ousmane/Cloud-Cybersecurity-Portfolio/blob/main/Cloud-AWS%20/Security/Analyse/Capture%20images/Image1.png?raw=true
...
> **Qu'est-ce qu'un tableau de bord CloudWatch ?**  
...
- [x] **Créer une notification Amazon SNS**
- [x] **Configurer une alarme CloudWatch**
- [x] **Soumettre une instance EC2 à un test de contrainte**
- [x] **Confirmer qu’un e-mail Amazon SNS a été envoyé**
- [x] **Créer un tableau de bord CloudWatch**
